...
## Google Drive
* **I file PDF da protocollare vengono scaricati da un repository Google Drive**, suddivisi nelle cartelle previste (`acquisti_da_protocollare`, `vendite_da_protocollare` e relative sottocartelle).
...
* **Rimuovi i PDF da protocollare che risultano già protocollati**, evitando duplicazioni se ci sono pdf vecchi nella cartella del programma.
